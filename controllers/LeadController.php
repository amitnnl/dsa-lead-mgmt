...
class LeadController {
    ...
    private function extractLeadData(array $post): array {
        return [
            ...
            'father_name'     => Security::sanitize($post['father_name'] ?? ''),
            ...
            'account_number'  => Security::sanitize($post['account_number'] ?? ''),
            'ifsc_code'       => strtoupper(Security::sanitize($post['ifsc_code'] ?? '')),
